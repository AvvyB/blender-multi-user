...
The multi-user addon is an attempt to experiment real-time parallelisation between different production stage. By replicating blender data blocks over the networks, it allows different artists to collaborate on a same scene in real-time.
